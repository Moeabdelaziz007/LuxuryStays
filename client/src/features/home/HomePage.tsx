...
export default function HomePage() {
  return (
    <div className="text-white min-h-screen relative">
      {/* Apply the tech space background to the entire page */}
      ...
      <div className="relative z-10">
        ...
        <section className="py-20 bg-opacity-80 backdrop-filter backdrop-blur-sm">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-gray-900 bg-opacity-80 p-8 rounded-xl border border-gray-800 relative overflow-hidden backdrop-filter backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-right">
                  <div>
                    ...
                    <div className="space-y-3">
                      <p className="text-gray-300 flex items-center justify-end gap-2">
        ...
        {/* ✨ قسم التذييل */}
        <footer className="py-10 bg-black bg-opacity-80 backdrop-filter backdrop-blur-sm">
          <div className="container mx-auto px-4">
