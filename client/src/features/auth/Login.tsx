        ...
        <div className="relative w-full md:w-1/2 px-4 sm:px-6 lg:px-8 z-10">
          <div className="backdrop-blur-lg bg-black/40 p-5 sm:p-8 rounded-2xl shadow-[0_0_30px_rgba(0,0,0,0.3)] 
            ...
            <button 
              ...
              className="relative group flex items-center justify-center gap-2 bg-transparent border border-[#39FF14]/30 backdrop-blur-sm text-white font-medium py-3 px-4 rounded-lg w-full hover:bg-[#39FF14]/10 transition-all active:scale-[0.98] mt-3"
