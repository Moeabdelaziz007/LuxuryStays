...
const GoogleLoginButton = ({ onLogin, loading, className, buttonText, redirectPath }: any) => (
  <Button 
...
const GuestLoginButton = ({ onLogin, loading, className, buttonText, redirectPath }: any) => (
  <Button 
