 ...
 * 
 * ملاحظة: يختلف هذا المكون عن FirestoreErrorHandler في أنه:
 * 1. يستخدم React Error Boundary API لاعتراض جميع أخطاء التشغيل
 * 2. يفحص نص الخطأ لتحديد ما إذا كان متعلقًا بقاعدة البيانات
 * 3. يمكن استخدامه حول أي مكون يتفاعل مع قاعدة البيانات لاعتراض الأخطاء بشكل مستقل
 */
